            ...
            <cell>
                <slider class="list-box fication-wrapper">
                    <div class="fication-wrapper-list list-box-child" v-for="(item,cindex) in nav.navWrapperList" :key="cindex">
                        <div class="fication-wrapper-list-child" v-for="(list,index) in nav.navWrapperList[cindex]" @click="jump('components/seafood/seafood.js?CategoryId=' + list.CategoryId)" :key="index">
