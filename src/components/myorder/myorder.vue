<template>
	<div>
		...
		<div class="titleBar">
			...
			<!--标题栏-->
			<wxc-minibar title="我的订单" background-color="#73cc00" text-color="#FFFFFF" left-button='../src/common/images/backImage.png' @wxcMinibarLeftButtonClicked="minibarLeftButtonClick">
