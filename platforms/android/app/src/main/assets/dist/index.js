...
var router = __webpack_require__(18); /*global Vue*/
// import router from './router'
/* weex initialized here, please do not move this line */

var App = __webpack_require__(143);
var Vuex = __webpack_require__(147);
Vue.use(Vuex);
...
var _FindPassword = __webpack_require__(36);

var _FindPassword2 = _interopRequireDefault(_FindPassword);

var _seafood = __webpack_require__(40);
...
var _GoodsInfo = __webpack_require__(61);
...
var _setlemet = __webpack_require__(111);

var _setlemet2 = _interopRequireDefault(_setlemet);

var _goods = __webpack_require__(115);

var _goods2 = _interopRequireDefault(_goods);

var _my = __webpack_require__(119);

var _my2 = _interopRequireDefault(_my);

var _checkstand = __webpack_require__(123);
                            ...
                            _utils2.default.jump({
                                "phoneJump": function phoneJump() {
                                    ...
                                    weex.requireModule('navigator').push({
                                        url: _utils2.default.urlPort().urlAddPort + 'dist/' + "index.js",
                                        animated: "true"
                                    }, function (event) {});
                                },
        ...
        link: function link(urls) {
            ...
            _utils2.default.jump({
                "phoneJump": function phoneJump() {
                    var bundleUrl = self.bundleUrl;
                    weex.requireModule('navigator').push({
                        url: _utils2.default.urlPort().urlAddPort + 'dist/' + urls.phone,
                        animated: "true"
                    }, function (event) {});
                },
                "webJump": function webJump() {
                    self.$router.push({ name: urls.web });
                }
            });
        }
    },
  ...
  return _c('div', [_c('image', {
    ...
    on: {
      "click": function($event) {
        _vm.link({
          'phone': 'components/login/FindPassword.js',
          'web': 'FindPassword'
        })
      }
    }
    ...
    on: {
      "click": function($event) {
        _vm.link({
          'phone': 'components/login/register.js',
          'web': 'register'
        })
      }
    }
...
var _orderHeader = __webpack_require__(6);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('header', {
    ...
    on: {
      "click": function($event) {
        _vm.link({
          'phone': 'components/main/GoodsInfo/Goods.js',
          'web': 'goodIn',
          'name': 'ProductId',
          'ProductId': _vm.abc
        })
    ...
    staticClass: ["shop-car-num"]
  }, [_vm._v(_vm._s(_vm.CarNum))]) : _vm._e()]), _vm._m(0), _vm._m(1)])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["collection"]
  }, [_c('text', {
        ...
        jump: function jump(urls) {
            ...
            _utils2.default.jump({
                "phoneJump": function phoneJump() {
                    var bundleUrl = self.bundleUrl;
                    weex.requireModule('navigator').push({
                        url: _utils2.default.urlPort().urlAddPort + 'dist/' + urls.phone + '?' + urls.name + '=' + urls.CategoryId,
                        animated: "true"
                    }, function (event) {});
                },
                "webJump": function webJump() {
    ...
    return _c('div', {
      ...
      return _c('div', {
        ...
        on: {
          "click": function($event) {
            _vm.jump({
              'phone': 'components/main/seafood/seafood.js',
              'web': 'seafood',
              'name': 'CategoryId',
...
var _wxcStepper = __webpack_require__(92);

var _wxcStepper2 = _interopRequireDefault(_wxcStepper);

var _wxcCheckboxList = __webpack_require__(97);

var _wxcCheckboxList2 = _interopRequireDefault(_wxcCheckboxList);

var _wxcCheckbox = __webpack_require__(109);
		...
		jump: function jump(urls) {
			...
			_utils2.default.jump({
				"phoneJump": function phoneJump() {
					var bundleUrl = self.bundleUrl;
					weex.requireModule('navigator').push({
						url: _utils2.default.urlPort().urlAddPort + 'dist/' + '?CartIds=' + CartIds,
						animated: "true"
					}, function (event) {});
				},
				"webJump": function webJump() {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "click": function($event) {
        _vm.jump({
          'phone': 'components/main/shop/setlemet.js',
          'web': 'setlemet'
        })
      }
    }
...
var _wxcRadio = __webpack_require__(126);

var _wxcRadio2 = _interopRequireDefault(_wxcRadio);

var _wxcDialog = __webpack_require__(136);
