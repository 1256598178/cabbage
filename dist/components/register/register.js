...
__vue_options__.__file = "F:\\WebApp\\cabbage\\src\\components\\register\\register.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-c5f2b744"
...
//验证码url
var CODE_URL = 'api/account/getsmscode';
//注册url
var REGISTER_URL = 'api/account/register';
exports.default = {
	components: {
					...
					_utils2.default.WeexAjax({
						...
						callback: function callback(ret) {
							...
							if (ret.Status == 0) {
								...
								// 		})
								// 		setTimeout(function(){
								// Util.bindThis(Util.jump('index.js'),self.$getConfig())
								// 		},2000)
							} else {
								modal.toast({
									message: '请求错误',
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("完成注册")])]), _vm._m(1), _c('text', {
    staticClass: ["forgot-text"]
  }, [_vm._v(_vm._s(_vm.ss))])])])
