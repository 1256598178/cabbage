...
__vue_options__.__file = "F:\\WebApp\\cabbage\\src\\components\\seafood\\seafood.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b8d910c0"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var modal = weex.requireModule('modal');
var SEAFOOD_URL = 'api/product/getprodcutlistbypage?';
exports.default = {
	data: function data() {
		return {
			titleName: '海鲜水产',
	...
	methods: {
		onloading: function onloading() {
			...
			_utils2.default.WeexAjax({
				url: SEAFOOD_URL + 'categoryId=' + _utils2.default.analAjax().CategoryId + '&page=' + (_this.pageAjax.page + 1) + '&pageSize=' + _this.pageAjax.pageSize,
